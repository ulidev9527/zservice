...
// 英文男姓
var __random_name_first_en_man = []string{
...
// 英文女姓
var __random_name_first_en_woman = []string{
...
// 英文名
var __random_name_last_en = []string{
...
// 中文姓
var __random_name_first_zh = []string{
	"王", "李", "张", "刘", "陈", "杨", "赵", "黄", " 周", "吴",
	"徐", "孙", "胡", "朱", "高", "林", "何", "郭", " 马", "罗",
	"梁", "宋", "郑", "谢", "韩", "唐", "冯", "于", " 董", "萧",
	"程", "曹", "袁", "邓", "许", "傅", "沈", "曾", " 彭", "吕",
...
// 中文名
var __random_name_last_zh = []string{
	"伟", "芳", "娜", "秀英", "敏", "静", "丽", "强", "磊", "军",
	"洋", "勇", "艳", "杰", "娟", "涛", "明", "超", "秀兰", "霞",
	"平", "刚", "桂"}

// 中文昵称
var __random_nickname_first_zh = []string{
...
// 中文昵称
var __random_nickname_last_zh = []string{
...
// 随机一个英文名
func RandomName_EN() string {
	if rand.Int()%2 == 0 {
		return fmt.Sprintf("%s %s", __random_name_first_en_woman[rand.Intn(len(__random_name_first_en_woman))], __random_name_last_en[rand.Intn(len(__random_name_last_en))])
	} else {
		return fmt.Sprintf("%s %s", __random_name_first_en_man[rand.Intn(len(__random_name_first_en_man))], __random_name_last_en[rand.Intn(len(__random_name_last_en))])
	}
}

// 随机一个中文名
func RandomName_ZH() string {
	return fmt.Sprint(__random_name_first_zh[rand.Intn(len(__random_name_first_zh))], __random_name_last_zh[rand.Intn(len(__random_name_last_zh))])
}

// 随机一个中文昵称
func RandomNickname_ZH() string {
	return fmt.Sprint(__random_nickname_first_zh[rand.Intn(len(__random_nickname_first_zh))], __random_nickname_last_zh[rand.Intn(len(__random_nickname_last_zh))])
}

// 随机一个名字
func RandomName() string {
	if rand.Int()%2 == 0 {
		return RandomName_EN()
	} else {
		return RandomName_ZH()
	}
}
