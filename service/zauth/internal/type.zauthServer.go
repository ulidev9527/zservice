...
func (s *ZauthServer) Logout(ctx context.Context, in *zauth_pb.Default_REQ) (*zauth_pb.Default_RES, error) {
	return Logout(grpcservice.GetCtxEX(ctx), in), nil
}
