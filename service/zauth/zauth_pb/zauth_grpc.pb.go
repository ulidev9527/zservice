...
type ZauthClient interface {
	...
	LoginCheck(ctx context.Context, in *LogicCheck_REQ, opts ...grpc.CallOption) (*Default_RES, error)
...
func (c *zauthClient) LoginCheck(ctx context.Context, in *LogicCheck_REQ, opts ...grpc.CallOption) (*Default_RES, error) {
	out := new(Default_RES)
...
type ZauthServer interface {
	...
	LoginCheck(context.Context, *LogicCheck_REQ) (*Default_RES, error)
...
func (UnimplementedZauthServer) LoginCheck(context.Context, *LogicCheck_REQ) (*Default_RES, error) {
...
func _Zauth_LoginCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZauthServer).LoginCheck(ctx, req.(*LogicCheck_REQ))
	}
	return interceptor(ctx, in, info, handler)
}
